...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="nav-justified">
        <tr>
            <td class="auto-style1">
                <label style="float: right; margin-right: 0px;">Seleccione o fornecedor a avaliar</label>
            </td>
    ...
    <table class="nav-justified">
        <tr>
            <td class="auto-style1">
                <label style="float: right; margin-right: 0px;">Comunicação</label></td>
            <td>
        ...
        <tr>
            <td class="auto-style1">
                <label style="float: right; margin-right: 0px;">Simpatia</label></td>
            <td>
        ...
        <tr>
            <td class="auto-style1">
                <label style="float: right; margin-right: 0px;">Preço</label></td>
            <td>
        ...
        <tr>
            <td class="auto-style1">
                <label style="float: right; margin-right: 0px;">Serviço</label></td>
            <td>
        ...
        <tr>
            <td class="auto-style1">
                <label style="float: right; margin-right: 0px;">Global</label></td>
            <td>

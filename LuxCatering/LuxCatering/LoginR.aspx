<%@ Page Language="C#"  MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LoginR.aspx.cs" Inherits="LuxCatering.User" %>
<asp:Content ID="Content1" runat="server" contentplaceholderid="MainContent">
    ...
    <div>
        ...
        <asp:LoginView ID="LoginView2" runat="server">
            <AnonymousTemplate>
                <asp:Login ID="Login1" runat="server" Height="270px" Width="687px">
                    <LayoutTemplate>
                        <table cellpadding="1" cellspacing="0" style="border-collapse:collapse;">
                            <tr>
                                <td>
                                    <table cellpadding="0" style="height:270px;width:687px;">
                                        <tr>
